...
if (isset($_POST['update_copy'])){
    ...
    $query = "UPDATE `shop_two` SET `stname`='$sname', `staddress`='$saddress', `stmobile`='$mobile' WHERE `id`='1'";
                    ...
                    if ($result){
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="sname" id="inputEmail3" value="<?=$row['stname']?>">
                                    <?php
                                    if (isset($cat_error)){
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="saddress" id="inputEmail3" value="<?=$row['staddress']?>">
                                    <?php
                                    if (isset($cat_error)){
                                        echo "<span class='text-danger'>$cat_error</span>";
                                    }
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="mobile" pattern="01[1|8|5|6|9|7][0-9]{8}" id="inputEmail3" value="<?=$row['stmobile']?>">
                                    <?php
                                    if (isset($cat_error)){
                                        echo "<span class='text-danger'>$cat_error</span>";
                                    }
